...
class CustomOrderListCardCondAwaitApprove extends StatelessWidget {

  const CustomOrderListCardCondAwaitApprove({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ViewAwaitApproveControllerImp>(
      id: "ViewAwaitApprove",
