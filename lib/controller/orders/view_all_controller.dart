...
import 'package:e_commerce/data/datasource/remote/orders/viewAll_data.dart';
...
abstract class ViewAllOrdersController extends GetxController {
  getViewAllOrdersData();
  refreshPage();
  resendAndRemove(OrderViewAllsModel order);
  removeOrder(OrderViewAllsModel order);
  viewOrderDetails(OrderViewAllsModel order);
}

class ViewAllOrdersControllerImp extends ViewAllOrdersController {
  List<OrderViewAllsModel> data = [];
  StatusRequest statusRequest = StatusRequest.loading;
  OrdersViewAllData ordersViewAllData = OrdersViewAllData(Get.find());
  ...
  @override
  getViewAllOrdersData() async {
    data.clear();
    statusRequest = StatusRequest.loading;
    update(["ViewAllOrders"]);
    var response = await ordersViewAllData.getData(
    ...
    if (statusRequest == StatusRequest.success &&
      ...
      data.addAll(listData.map((e) => OrderViewAllsModel.fromJson(e)));
    } else {
